...
grown a different number of times. With $h^2=0.5$, the shrinkage weight $w_i = n_i h^2 / (n_i h^2 + (1-h^2))$ pulls each raw value toward 0 — *hard* for 1-rep lines, *barely* for 6-rep lines:
